...
@section('maincontent')
<!-- BANNER -->
<div class="blog_banner" style="background: url('/images/banner.jpg') no-repeat center center;">
							...
							<div class="blog_post_r8_all">
								...
								<div class="blog_post_r8_item">
									...
									<div class="blog_post_item_r8">
										...
										<a href=""><p class="author_name2">-{{$rel->user->fullName}}</p></a>
									</div>
                                </div>
                                @endforeach
                                @endif
								...
								<ul class="post_tags_ul">
                                    @if (count($blog->tags) > 0)
                                        @foreach ($blog->tags as $t)
                                            <li>
                                                <a href="/tag/{{$t->title}}/{{$t->id}}">{{$t->title}}</a>
                                            </li>
